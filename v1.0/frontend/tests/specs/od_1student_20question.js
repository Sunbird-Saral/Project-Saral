...
describe('saral app test', () => {
  it('find elements', async () => {
    ...
    LOGIN.loginIds("od001", "tarento@123");
    ...
    await AppObject.selectSubject_2D_od.click();
  ...
  it('studend deatil and after scan test', async () => {
   ...
   const submitBtn = await AppObject.SUBMIT;
   ...
   await submitBtn.click();
    ...
    await scanStatusBtn.waitForDisplayed();
   assert.equal(await scanStatusBtn.isDisplayed(), true)

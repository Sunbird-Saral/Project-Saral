...
import {
  removeAllCache,
  removeMinimalUserCache,
  removeRegularUserCache,
    ...
    return (
      <View style={{flex: 1, marginTop: '10%', marginRight: '5%'}}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    callCustomModal(
                      ...
                      Strings.are_you_sure_you_want_to_clear_local_cache,
                      true,
                      removeLocalCache,
                      true,
                    );
              ...
              loginData.data.school.offlineMode && (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    callCustomModal(
                      Strings.message_text,
                      Strings.are_you_sure_you_want_to_clear_global_cache,
                      true,
                      removeGlobalCache,
                      true,
                    );
        ...
        {versionText && versionText.length > 0 && (
          <Text
            style={[
              styles.versionTxtStyle,
            ]}>{`${Strings.version_text}: ${versionText}`}</Text>
        )}
        {headerButton && (
          <TouchableOpacity

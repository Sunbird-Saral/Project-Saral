...
const ScanStatus = ({
  ...
  const BrandLabel =
    ...
    multiBrandingData.screenLabels.scanStatus[0];
  ...
  const renderItem = ({item, index}) => {
    return (
      <ScanStatusList
        ...
        themeColor2={
          multiBrandingData ? multiBrandingData.themeColor2 : AppTheme.BLUE
        }
        scanitemdata={item}
        index={index}
        id={item.studentId}
                ...
                hasSet == null
                  ? o.studentAvailability &&
                    (o.marksInfo.length > 0) &
                      (o.examDate == filteredData.examDate)
                  : hasSet.length >= 0
                  ? o.studentAvailability &&
                    o.marksInfo.length > 0 &&
                    hasSet == o.set

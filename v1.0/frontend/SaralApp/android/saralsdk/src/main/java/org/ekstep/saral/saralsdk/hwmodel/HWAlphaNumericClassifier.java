...
public class HWAlphaNumericClassifier {
    private static final String TAG             = "SrlSDK::HWAlphaNumericClassify";
    private static HWAlphaNumericClassifier mInstance       = null;
    ...
    private static final String LOCAL_MODEL_ASSET = "hw_alphanumeric.tflite";
    private static final String FB_REMOTE_MODEL   = "hw_alphanumeric";
    /**
    ...
    public static HWAlphaNumericClassifier getInstance() {
        if (mInstance == null) {
            mInstance   = new HWAlphaNumericClassifier();
        }
        return mInstance;
    }

    private HWAlphaNumericClassifier() {
    }
    ...
    public void HWAlphaNumericClassifierCallback(PredictionListener listener) throws IOException {
    ...
    public void initialize(HWAlphaNumericClassifierStatusListener listener, boolean isFBDownloadEnable, Context context) {
    ...
    public void localModelAsset (HWAlphaNumericClassifierStatusListener listener, Context context) throws FirebaseMLException {

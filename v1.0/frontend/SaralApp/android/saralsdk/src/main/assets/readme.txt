Handwritten Digits model information - iteration 3
--------------------------------------------------
latest trained model: saral_hwd_model.tflite
trained for: 25 epochs
trained upon: resnet_trained_model_digit_with_printed_v1_new_finetune_13_08_22_epoch_5_tflite.tflite
augmentations used: Yes
dataset used: Existing dataset + NIST misclassifications (hsf_0 subset of each class)

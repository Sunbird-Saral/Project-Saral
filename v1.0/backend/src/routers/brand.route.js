...
// router.post('/brand?',auth,brandController.createBrandData)
router.get('/brand',auth,brandController.fetchBrandData)
router.get('/brand/default',auth,brandController.fetchDefaultBrandData)
// router.delete('/brand',auth,brandController.deleteBrandData)
// router.put('/brand',auth,brandController.updateBrandData)

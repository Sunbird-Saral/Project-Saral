...
router.post('/student',auth,studentController.createStudent)
router.post('/fetchStudentsByQuery',auth,studentController.fetchStudentsData)
...
router.patch('/student/:studentId',auth,studentController.updateStudent)
